...
def fps(data1, number):
    '''
        data B N 3
        number int
    '''
    fps_idx = pointnet2_utils.furthest_point_sample(data1, number)
    fps_data1 = pointnet2_utils.gather_operation(data1.transpose(1, 2).contiguous(), fps_idx).transpose(1,2).contiguous()
    # fps_data2 = pointnet2_utils.gather_operation(data2.transpose(1, 2).contiguous(), fps_idx).transpose(1,2).contiguous()
    return fps_data1, fps_idx
